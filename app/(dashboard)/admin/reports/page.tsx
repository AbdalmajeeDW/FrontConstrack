...
const mockReports: Report[] = [
  {
    ...
    category: "project",
    description: "Volledig overzicht van alle projectvoortgang en mijlpalen voor juni 2026",
  ...
  },
  {
    ...
    category: "financial",
    description: "Begrotingsanalyse, kostenverdeling en financiële prognoses voor Q2",
  ...
  },
  {
    ...
    category: "hr",
    description: "Productiviteit van werknemers, taakvoltooiingspercentages en teamefficiëntie",
  ...
  },
  {
    ...
    category: "resource",
    description: "Distributie van middelen, apparatuurgebruik en materiaaltracking",
  ...
  },
  {
    ...
    category: "financial",
    description: "Analyse van begrotingsafwijkingen voor alle actieve projecten",
...
const categoryConfig = {
  ...
  financial: { label: "Financial", color: "bg-emerald-100 text-emerald-700", icon: Euro },
...
const statusConfig = {
  ...
  failed: { label: "Failed", color:"bg-blue-100 text-blue-700", icon: AlertCircle },
};
